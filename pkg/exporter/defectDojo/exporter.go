...
func (e Exporter) getEngagement(productID int, name string) (*models.Engagement, error) {
	...
	return e.service.PostEngagement(models.Engagement{
		...
		TargetStart:             time.Now().In(loc).Format("2006-02-01"),
		TargetEnd:               time.Now().In(loc).Add(e.config.EngagementDuration).Format("2006-02-01"),
		Product:                 productID,
		Active:                  true,
		Status:                  "In Progress",
...
func autoGenDescription() string {
	...
	return fmt.Sprintf("Product Type auto-generated by Gate Check %s", timeStamp)
}
